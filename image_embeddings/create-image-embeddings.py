...
ES_HOST = "https://10.8.230.25:9200/"
ES_USER = "xyperia"
ES_PASSWORD = "xyperia"
ES_TIMEOUT = 3600

DEST_INDEX = "xyperia-images"
DELETE_EXISTING = True
CHUNK_SIZE = 100

PATH_TO_IMAGES = "../app/static/images/**/*.jp*g"
PREFIX = "../app/static/images/"
WINDOWS_PREFIX = ".\\app\\static\\images\\"
...
def main():
    ...
    for filename in tqdm(filenames, desc='Processing files', total=len(filenames)):
        ...
        doc['relative_path'] = os.path.relpath(filename).split(WINDOWS_PREFIX)[1]
        doc['exif'] = {}
